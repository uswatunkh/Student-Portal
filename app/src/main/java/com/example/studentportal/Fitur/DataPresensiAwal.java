...
public class DataPresensiAwal {
    ...
    public DataPresensiAwal() {
    }


    public DataPresensiAwal (String semester, String idRekapPresensi, String hadir, String izin,String sakit, String kosong) {
        Semester = semester;
