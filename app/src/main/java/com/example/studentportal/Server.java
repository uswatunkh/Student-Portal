...
//    public static final String BASE_URL = "http://192.168.1.42/studentPortal/DownloadPdf/";
    ...
    public static final String URL = " http://studentportal.link/";
    public static final String URLKeterampilan = "http://studentportal.link/KeterampilanApi/";
    public static final String URLEvaluasiDosen = "http://studentportal.link/EvaluasiDosen/";
    //    public static final String UPLOAD_URL = "http://192.168.1.42/AndroidUploadImage/Keterampilan/upKeterampilan.php";
//    public static final String IMAGES_URL = "http://192.168.1.42/AndroidUploadImage/getImages.php";
    public static final String BASE_URL = "http://studentportal.link/DownloadPdf/";
}
