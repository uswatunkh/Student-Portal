...
public class KamisFragment extends Fragment {
    private static final String TAG= KamisFragment.class.getSimpleName() ;  //getting the info
    TextView dataKosong;
    ...
    private static String URL_READ = Server.URL + "readKamis.php";
...
//                                        .show();
                                ...
                                dataKosong.setText("Data Jadwal Hari Kamis Masih Kosong");
