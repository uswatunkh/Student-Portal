...
public class SelasaFragment extends Fragment {
    private static final String TAG= SelasaFragment.class.getSimpleName() ;  //getting the info
    TextView dataKosong;
    ...
    private static String URL_READ = Server.URL + "readSelasa.php";
...
//                                        .show();
                                ...
                                dataKosong.setText("Data Jadwal Hari Selasa Masih Kosong");
