...
public class JumatFragment extends Fragment {
    private static final String TAG= JumatFragment.class.getSimpleName() ;  //getting the info
    TextView dataKosong;
    ...
    private static String URL_READ = Server.URL + "readJumat.php";
...
//                                        .show();
                                ...
                                dataKosong.setText("Data Jadwal Hari Jumat Masih Kosong");
